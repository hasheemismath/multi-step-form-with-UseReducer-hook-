         ...
         <Grid item container>
            ...
            <Grid item lg={9} md={9} sm={9} xs={12}>
               <Box mt={5}>
                  ...
                  <p className={classes.text}>Dashboard | Cases</p>
                  <p className= {classes.heading}>Review</p>
                  ...
                  <Grid item container>
                     <Grid item lg={12} md={12} sm={12} xs={12}>
                        ...
                        <Link to="/success"><Button type="submit" className={classes.button} variant="contained">Create Case</Button></Link>
                     </Grid>
                  </Grid>
               </Box>
            </Grid>
